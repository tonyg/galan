...
#define GENERATOR_CLASS_NAME	"arradd"
#define GENERATOR_CLASS_PATH	"Array/Add"
...
PRIVATE void evt_input_handler(Generator *g, AEvent *event) {
	...
	case AE_NUMARRAY:
	    ...
	    break;
	default:
	    g_warning( "arradd does not support this eventkind\n" );
	    break;
    }
}
...
PRIVATE void setup_class(void) {
  ...
  gen_configure_event_input(k, EVT_FACTOR, "Offset", evt_factor_handler);
